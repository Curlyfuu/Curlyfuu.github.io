  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        ulTmpl = ulTmpl + '<section class="archives album"><h1 class="year"><a href="#data-year-data-month-yue" class="header-anchor"></a><span id="data-year-data-month-yue">' + data.year + '<em>' + data.month + '月</em></span></h1>\
